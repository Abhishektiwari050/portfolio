...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 6. Terminal Console >> should show terminal prompt
- Location: e2e\tier1-features.spec.ts:178:5
...
Locator: locator('[data-testid="terminal-console"]').getByText('$')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="terminal-console"]').getByText('$')
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 58 FPS PING: 38ms BUFF_OK: 100%"
  - img
