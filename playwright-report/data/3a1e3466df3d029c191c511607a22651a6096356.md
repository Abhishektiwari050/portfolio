...
- Name: tier3-combinations.spec.ts >> Tier 3: Cross-Feature Combinations >> 5. Scroll & Cursor Lock
- Location: e2e\tier3-combinations.spec.ts:53:3
...
```yaml
- img
- text: "X:216 Y:359 >_ Agent_Console_Stream Online SYNAPSE: Establishing link with Helios (Vector Search)... [10:53:02] SYNAPSE: Initializing communication channels... [10:53:04] SYNAPSE: Establishing link with Aetheris (Agent Swarm)... [10:53:05] SYNAPSE: Establishing link with Helios (Vector Search)... [10:53:07] SYNAPSE: Establishing link with Chronos (Grid Forecast)... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: SYNAPSE_ACTIVE SYS_STATUS: OPTIMAL SYS_HZ: 58 FPS PING: 41ms BUFF_OK: 100%"
  - img
