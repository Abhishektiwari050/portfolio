...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 7. Custom Cursor >> should update coordinates on move
- Location: e2e\tier1-features.spec.ts:204:5
...
Expected pattern: /X:\s*320\s+Y:\s*480/
Timeout: 8000ms
...
```yaml
- text: "X:320 Y:480 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:51:04] SYS: Booting Core Decryptor... [10:51:06] SYS: Loading WebGL rendering pipelines... [10:51:08] SYS: Initializing CatmullRom spline path... [10:51:10] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 59 FPS PING: 44ms BUFF_OK: 100%"
  - img
