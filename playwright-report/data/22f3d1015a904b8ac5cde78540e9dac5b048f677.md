...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 6. Terminal Console >> should render terminal console
- Location: e2e\tier1-features.spec.ts:158:5
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 59 FPS PING: 43ms BUFF_OK: 100%"
  - img
