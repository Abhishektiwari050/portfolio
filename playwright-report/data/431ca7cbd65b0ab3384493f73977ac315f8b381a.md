...
- Name: tier2-boundaries.spec.ts >> Tier 2: Boundary and Corner Cases >> 6. Terminal Console Boundaries >> resizing window recalculates terminal layout
- Location: e2e\tier2-boundaries.spec.ts:264:5
...
```yaml
- text: "X:0 Y:0 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:52:11] SYS: Booting Core Decryptor... [10:52:12] SYS: Loading WebGL rendering pipelines... [10:52:14] SYS: Initializing CatmullRom spline path... [10:52:16] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 61 FPS PING: 44ms BUFF_OK: 100%"
  - img
