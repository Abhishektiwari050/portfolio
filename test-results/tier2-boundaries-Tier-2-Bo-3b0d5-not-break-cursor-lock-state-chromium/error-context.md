...
- Name: tier2-boundaries.spec.ts >> Tier 2: Boundary and Corner Cases >> 5. Contact Section Boundaries >> right clicking links should not break cursor lock state
- Location: e2e\tier2-boundaries.spec.ts:185:5
...
```yaml
- img
- text: "X:216 Y:359 >_ Agent_Console_Stream Online SYNAPSE: Establishing link with Helios (Vector Search)... [10:52:04] SYNAPSE: Initializing communication channels... [10:52:05] SYNAPSE: Establishing link with Aetheris (Agent Swarm)... [10:52:07] SYNAPSE: Establishing link with Helios (Vector Search)... [10:52:09] SYNAPSE: Establishing link with Chronos (Grid Forecast)... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: SYNAPSE_ACTIVE SYS_STATUS: OPTIMAL SYS_HZ: 59 FPS PING: 42ms BUFF_OK: 100%"
  - img
