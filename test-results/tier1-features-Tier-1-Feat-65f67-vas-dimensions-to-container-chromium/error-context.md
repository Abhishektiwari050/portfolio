...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 9. 3D Canvas Rendering >> should match canvas dimensions to container
- Location: e2e\tier1-features.spec.ts:269:5

# Error details

```
Error: locator.boundingBox: Error: strict mode violation: locator('.right-column canvas') resolved to 2 elements:
...
- generic [ref=e3]:
  ...
  - generic [ref=e4]:
    ...
    - generic [ref=e8]:
      ...
      - generic [ref=e12]: "[10:51:23] SYS: Booting Core Decryptor..."
      - generic [ref=e13]: $ _
  - main [ref=e14]:
    - generic [ref=e15]:
      - generic [ref=e16]:
    ...
    - generic [ref=e154]:
      ...
      - generic [ref=e156]:
        - generic [ref=e161]:
          ...
          - generic [ref=e163]: "SYS_HZ: 59 FPS"
        - generic [ref=e164]:
          - generic [ref=e165]: "PING: 46ms"
