...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 6. Terminal Console >> should show terminal status online
- Location: e2e\tier1-features.spec.ts:168:5
...
Locator: locator('[data-testid="terminal-console"]').getByText('Online')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="terminal-console"]').getByText('Online')

```

```yaml
- text: "X:0 Y:0 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:50:47] SYS: Booting Core Decryptor... [10:50:49] SYS: Loading WebGL rendering pipelines... [10:50:50] SYS: Initializing CatmullRom spline path... [10:50:52] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 59 FPS PING: 41ms BUFF_OK: 100%"
  - img
