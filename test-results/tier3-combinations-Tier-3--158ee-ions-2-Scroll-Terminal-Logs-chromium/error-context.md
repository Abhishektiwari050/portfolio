...
- Name: tier3-combinations.spec.ts >> Tier 3: Cross-Feature Combinations >> 2. Scroll & Terminal Logs
- Location: e2e\tier3-combinations.spec.ts:20:3
...
```yaml
- text: "X:0 Y:0 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:52:46] SYS: Booting Core Decryptor... [10:52:48] SYS: Loading WebGL rendering pipelines... [10:52:49] SYS: Initializing CatmullRom spline path... [10:52:51] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 61 FPS PING: 38ms BUFF_OK: 100%"
  - img
