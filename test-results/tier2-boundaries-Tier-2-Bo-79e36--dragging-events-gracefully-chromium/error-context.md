...
- Name: tier2-boundaries.spec.ts >> Tier 2: Boundary and Corner Cases >> 7. Custom Cursor Boundaries >> cursor handles dragging events gracefully
- Location: e2e\tier2-boundaries.spec.ts:319:5
...
```yaml
- text: "X:300 Y:300 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:52:25] SYS: Booting Core Decryptor... [10:52:27] SYS: Loading WebGL rendering pipelines... [10:52:28] SYS: Initializing CatmullRom spline path... [10:52:30] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 60 FPS PING: 44ms BUFF_OK: 100%"
  - img
