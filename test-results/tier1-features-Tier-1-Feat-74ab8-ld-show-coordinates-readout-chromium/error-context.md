...
- Name: tier1-features.spec.ts >> Tier 1: Feature Coverage >> 7. Custom Cursor >> should show coordinates readout
- Location: e2e\tier1-features.spec.ts:199:5
...
```yaml
- text: "X:0 Y:0 >_ Agent_Console_Stream Online SYS: Initializing CatmullRom spline path... [10:50:52] SYS: Booting Core Decryptor... [10:50:54] SYS: Loading WebGL rendering pipelines... [10:50:56] SYS: Initializing CatmullRom spline path... [10:50:58] SYS: Calibrating CAD coordinate reticle... $ _"
- main:
...
- complementary:
  - text: "SYS_MODE: INITIALIZING SYS_STATUS: OPTIMAL SYS_HZ: 58 FPS PING: 40ms BUFF_OK: 100%"
  - img
